...
-- Get the last inserted revision id
-- (works in H2, but in other DBs you might need RETURNING or currval)
-- In H2, use SCOPE_IDENTITY()
-- For portability, we'll just assume revision 1 if REVINFO was empty

-- Populate SCHOOL_CLASS_AUD
...
-- Populate CLASS_PROFESSOR_AUD (join table)
